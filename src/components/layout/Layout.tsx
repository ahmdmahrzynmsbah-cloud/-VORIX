...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen bg-[#F0F4F8] print:bg-white text-[#1E293B] font-sans overflow-hidden print:overflow-visible print:h-auto print:block" dir="rtl">
      ...
      <div className={`fixed inset-y-0 right-0 z-50 p-3 sm:p-4 md:py-4 md:pr-4 md:pl-0 transform transition-all duration-300 ease-in-out md:relative md:translate-x-0 ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'} print:hidden flex-shrink-0 flex flex-col`}>
        <Sidebar 
