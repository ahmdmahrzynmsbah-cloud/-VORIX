...
export default function ConfirmDeleteModal({
 ...
 onClick={onClose}
 disabled={isDeleting}
 className="text-slate-400 hover:text-slate-600 p-1.5 rounded-lg hover:bg-slate-100 transition-colors disabled:opacity-50 cursor-pointer border-none bg-transparent"
 >
 <X className="w-5 h-5" />
 </button>
 </div>
