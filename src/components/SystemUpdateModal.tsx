  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-[#0F172A]/50 backdrop-blur-xs animate-fade-in print:hidden" dir="rtl">
      <div className="bg-white rounded-2xl shadow-xl border border-[#E2E8F0] max-w-sm w-full overflow-hidden relative max-h-[85vh] flex flex-col my-auto">
        ...
        {/* Header */}
        <div className="bg-gradient-to-r from-[#800020] to-[#A31535] text-[#F3E6D5] p-4 relative shrink-0">
          <button 
            onClick={handleClose}
            className="absolute top-3 left-3 p-1 text-white/70 hover:text-white bg-black/20 hover:bg-black/40 rounded-full transition-colors cursor-pointer border-none"
            title="إغلاق"
          >
            <X className="w-4 h-4" />
          </button>
          ...
          <div className="flex items-center gap-2 mb-1.5">
            <span className="px-2.5 py-0.5 bg-white/20 text-white border border-white/30 text-[11px] font-bold rounded-full flex items-center gap-1">
          ...
          <p className="text-[#F3E6D5]/80 text-xs mt-0.5">
        ...
        <div className="p-4 space-y-3 bg-slate-50 overflow-y-auto">
          ...
          <div className="space-y-2 text-xs">
            ...
            <div className="p-2.5 bg-white rounded-lg border border-slate-200 flex items-center gap-2.5">
              <Printer className="w-4 h-4 text-[#800020] shrink-0" />
              <div>
        ...
        {/* Footer */}
        <div className="p-3 bg-white border-t border-slate-200 flex items-center justify-end shrink-0">
          <button
            onClick={handleClose}
            className="w-full py-2.5 bg-gradient-to-r from-[#800020] to-[#A31535] hover:from-[#660019] hover:to-[#800020] text-[#F3E6D5] font-bold text-xs rounded-xl shadow-md shadow-[#800020]/25 transition-all cursor-pointer text-center border-none"
          >
            متابعة العمل
          </button>
        </div>
