...
export const PWAInstallButton: React.FC = () => {
  ...
  if (isInstallable) {
    return (
      <button
        onClick={install}
        className="flex items-center gap-2 rounded-2xl bg-gradient-to-r from-[#800020] to-[#A31535] hover:from-[#660019] hover:to-[#800020] px-3.5 py-1.5 text-xs font-bold text-[#F3E6D5] shadow-xs hover:shadow-md transition w-full sm:w-auto justify-center cursor-pointer"
      >
        <Download className="w-4 h-4 text-[#F3E6D5]" />
