...
export default function Customers() {
 ...
 <div className="text-left bg-white px-5 py-3 rounded-xl shadow-sm border border-slate-200 w-full sm:w-auto print:shadow-none print:px-4">
 ...
 <p className="text-xs text-[#800020] font-bold mb-1">العميل: {paymentCustomer.name}</p>
 <p className="text-sm text-slate-800 font-bold">الرصيد المستحق: <span className="text-xl inline-block mr-1 text-[#800020] font-mono">{Number(paymentCustomer.balance || 0).toLocaleString()}</span> ج.م</p>
 </div>
 ...
 <button type="button" onClick={() => setPaymentCustomer(null)} className="px-4 py-2.5 text-sm font-bold text-[#475569] bg-[#F1F5F9] rounded-xl hover:bg-[#E2E8F0] cursor-pointer">
 إلغاء
 </button>
 ...
 <input required type="text" value={newCustomer.name} onChange={e => setNewCustomer({...newCustomer, name: e.target.value})} className="w-full border border-slate-200 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-[#800020] focus:outline-none" />
 </div>
 <div className="space-y-1">
 <label className="text-xs font-bold text-[#475569]">رقم الهاتف (اختياري)</label>
 <input type="tel" value={newCustomer.phone} onChange={e => setNewCustomer({...newCustomer, phone: e.target.value})} className="w-full border border-slate-200 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-[#800020] focus:outline-none" dir="ltr" />
 </div>
 <div className="space-y-1">
 <label className="text-xs font-bold text-[#475569]">التاريخ</label>
 <input type="date" value={newCustomer.date} onChange={e => setNewCustomer({...newCustomer, date: e.target.value})} className="w-full border border-slate-200 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-[#800020] focus:outline-none" dir="ltr" />
 </div>
 <div className="space-y-1">
 ...
 <button type="button" onClick={closeModal} className="px-4 py-2 text-sm font-bold text-[#475569] bg-[#F1F5F9] rounded-xl hover:bg-[#E2E8F0] cursor-pointer">
 إلغاء
 </button>
 <button type="submit" className="px-5 py-2.5 text-sm font-bold text-[#F3E6D5] bg-gradient-to-r from-[#800020] to-[#A31535] hover:from-[#660019] hover:to-[#800020] rounded-xl cursor-pointer shadow-md shadow-[#800020]/25">
