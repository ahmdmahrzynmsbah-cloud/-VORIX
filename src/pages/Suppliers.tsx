  ...
  return (
    ...
    <div className={`space-y-6 ${selectedSupplierHistory || printingPurchase ? 'print:hidden' : ''}`}>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex gap-3">
          ...
          <button 
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#800020] to-[#A31535] hover:from-[#660019] hover:to-[#800020] px-4 py-2.5 text-sm font-bold text-[#F3E6D5] transition-all shadow-md shadow-[#800020]/25 cursor-pointer"
          >
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm flex flex-col">
        <div className="p-5 border-b border-slate-200 flex flex-col sm:flex-row gap-4 justify-between items-center">
          <div className="relative w-full sm:max-w-md">
            ...
            <input
              ...
              className="block w-full bg-slate-50 border border-slate-200 rounded-xl pr-10 pl-4 py-2 text-sm focus:ring-2 focus:ring-[#800020] focus:outline-none"
                      ...
                      {supplier.phone && (
                        <div className="flex items-center gap-2 mt-1">
                          <a 
                            ...
                            className="text-xs font-mono font-medium text-[#800020]  hover:underline"
                            dir="ltr"
                          >
                            {supplier.phone}
                          </a>
                ...
                <div className="flex items-center justify-between pt-1 border-t border-[#E2E8F0]/70 flex-wrap gap-2">
                  <div className="flex items-center gap-1.5">
                    <button 
                      ...
                      className="px-3 py-1.5 bg-[#F3E6D5]/60 text-[#800020]   rounded-lg font-bold text-xs hover:bg-[#F3E6D5] transition-colors border border-[#800020]/20  flex items-center gap-1 cursor-pointer"
                    >
                  ...
                  <div className="flex items-center gap-1.5 mr-auto">
                    <button 
                      ...
                      className="p-1.5 bg-white border border-[#E2E8F0] text-[#475569] rounded-lg hover:bg-slate-50 hover:text-[#800020]  transition-colors cursor-pointer"
                      title="تعديل"
                    >
        ...
        <div className="hidden md:block overflow-x-auto">
          <table className="w-full text-right">
            <thead className="bg-[#F7FAFC]  text-xs font-bold text-[#475569]  uppercase tracking-wider border-b border-[#E2E8F0] ">
              <tr>
                      ...
                      <div className="flex items-center justify-center gap-2">
                        ...
                        {supplier.balance > 0 && (
                          <button 
                            ...
                            className="inline-flex items-center justify-center gap-2 px-3 py-2 bg-[#F3E6D5]/60 text-[#800020]   rounded-lg font-bold text-xs hover:bg-[#F3E6D5] transition-colors border border-[#800020]/20  cursor-pointer"
                          >
                        ...
                        <button 
                          ...
                          className="inline-flex items-center justify-center w-8 h-8 bg-white border border-[#E2E8F0] text-[#475569] rounded-lg hover:bg-slate-50 hover:text-[#800020]  transition-colors cursor-pointer"
                        >
                          <Edit2 className="w-4 h-4" />
                        </button>
                        <button 
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl overflow-hidden flex flex-col max-h-[92vh] print:max-h-none print:max-w-none print:w-full print:mx-0 print:h-auto print:shadow-none print:rounded-none border border-[#E2E8F0] print:border-none print:overflow-visible">
            <div className="px-4 sm:px-6 py-3.5 border-b border-[#E2E8F0] flex flex-wrap gap-2 justify-between items-center bg-[#F8FAFC] print:hidden">
              ...
              <div className="flex items-center gap-2">
                 ...
                 <button onClick={handlePrintStatement} className="inline-flex items-center justify-center gap-1.5 px-3 sm:px-4 py-2 bg-[#800020] text-[#F3E6D5] rounded-xl font-bold text-xs hover:bg-[#660019] transition-colors border-none cursor-pointer shadow-sm">
            ...
            <div id="supplier-statement-printable-area" className="p-4 sm:p-6 overflow-y-auto space-y-6 print:overflow-visible print:p-2 bg-white">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center bg-slate-50 p-4 rounded-xl border border-slate-200 gap-4 print:bg-transparent print:border-none print:p-0 print:items-end print:mb-6">
                <div className="flex items-center gap-3 text-right print:gap-2">
                  <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center text-[#800020]  shadow-sm print:hidden flex-shrink-0 min-w-[48px] border border-slate-200" dir="ltr">
      ...
      {isAddSupplierModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#1A2332]/50 backdrop-blur-sm p-4">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden flex flex-col max-h-[90vh] border border-slate-200">
            ...
            <form onSubmit={handleAddSupplier} className="p-6 overflow-y-auto space-y-4">
              <div className="space-y-1">
                ...
                <input required type="text" value={newSupplier.name} onChange={e => setNewSupplier({...newSupplier, name: e.target.value})} className="w-full border border-slate-200 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-[#800020] focus:outline-none" />
              </div>
              <div className="space-y-1">
                <label className="text-xs font-bold text-[#475569]">رقم هاتف المورد (اختياري)</label>
                <input type="tel" value={newSupplier.phone} onChange={e => setNewSupplier({...newSupplier, phone: e.target.value})} className="w-full border border-slate-200 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-[#800020] focus:outline-none" dir="ltr" />
              </div>
              <div className="space-y-1">
                <label className="text-xs font-bold text-[#475569]">التاريخ</label>
                <input type="date" value={newSupplier.date} onChange={e => setNewSupplier({...newSupplier, date: e.target.value})} className="w-full border border-slate-200 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-[#800020] focus:outline-none" dir="ltr" />
              </div>
              <div className="space-y-1">
                ...
                <input 
                  ...
                  className="w-full border border-slate-200 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-[#800020] focus:outline-none" 
                />
                <p className="text-[10px] text-[#94A3B8]">الموجب يعني أن للمورد مستحقات لديك سابقة.</p>
              </div>
              <div className="pt-4 flex justify-end gap-3 border-t border-slate-200 mt-6">
                <button type="button" onClick={closeSupplierModal} className="px-4 py-2 text-sm font-bold text-[#475569] bg-[#F1F5F9] rounded-xl hover:bg-[#E2E8F0] cursor-pointer">إلغاء</button>
                <button type="submit" className="px-5 py-2.5 text-sm font-bold text-[#F3E6D5] bg-gradient-to-r from-[#800020] to-[#A31535] hover:from-[#660019] hover:to-[#800020] rounded-xl cursor-pointer shadow-md shadow-[#800020]/25">{editingSupplier ? 'تحديث البيانات' : 'حفظ المورد'}</button>
              </div>
            </form>
          </div>
        </div>
            ...
            <form onSubmit={handleCreatePurchase} className="p-6 overflow-y-auto space-y-6">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {purchaseItems.map((item, idx) => (
                    <div key={`purchase-item-${idx}`} className="flex flex-col gap-2 bg-[#F1F5F9] p-3 rounded-lg border border-[#E2E8F0]">
                       <div className="flex items-center justify-between mb-1">
                          ...
                          <div className="flex items-center gap-3">
                            <label className="flex items-center gap-2 cursor-pointer text-xs font-bold text-[#800020]">
                  ...
                  <button type="button" onClick={() => setPurchaseItems([...purchaseItems, { inventoryId: '', isNew: false, newName: '', newSellPrice: 0, qty: 1, cost: 0 }])} className="text-xs font-bold text-[#800020]  hover:underline cursor-pointer">
                    + إضافة صنف آخر
                  </button>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-xl w-full max-w-sm overflow-hidden flex flex-col border border-slate-200">
            <div className="px-5 py-4 border-b border-slate-200 flex justify-between items-center bg-slate-50">
              <h3 className="font-bold text-lg text-[#1E293B] flex items-center gap-2">
                <Banknote className="w-5 h-5 text-[#800020] " />
            ...
            <form onSubmit={handlePaymentSupplier} className="p-5 space-y-4">
              <div className="bg-slate-50 p-3 rounded-xl border border-slate-200">
                <p className="text-xs text-[#800020]  font-bold mb-1">المورد: {paymentSupplier.name}</p>
                <p className="text-sm text-slate-800 font-bold">المطلوب سداده: <span className="text-xl inline-block mr-1 text-[#800020]  font-mono">{Number(paymentSupplier.balance || 0).toLocaleString()}</span> ج.م</p>
              </div>
              ...
              <div className="space-y-1">
                ...
                <input 
                  ...
                  className="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm font-bold text-[#1E293B] focus:ring-2 focus:ring-[#800020] focus:outline-none bg-white"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full border border-slate-200 rounded-xl px-4 py-3 text-lg font-bold flex-1 text-left focus:ring-2 focus:ring-[#800020] focus:outline-none" 
                    dir="ltr"
                  />
              ...
              <div className="pt-4 flex justify-end gap-3 mt-2">
                <button type="button" onClick={() => setPaymentSupplier(null)} className="px-4 py-2.5 text-sm font-bold text-[#475569] bg-[#F1F5F9] rounded-xl hover:bg-[#E2E8F0] cursor-pointer">
                  إلغاء
                </button>
                <button type="submit" className="px-6 py-2.5 text-sm font-bold text-[#F3E6D5] bg-gradient-to-r from-[#800020] to-[#A31535] hover:from-[#660019] hover:to-[#800020] rounded-xl cursor-pointer shadow-md shadow-[#800020]/25">
                  تأكيد السداد
                </button>
              </div>
            </form>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0F172A]/50 backdrop-blur-sm p-4 print:p-0 print:bg-transparent print:backdrop-blur-none print:items-start print:block print:static print:inset-auto">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-4xl overflow-hidden flex flex-col max-h-[90vh] print:max-h-none print:max-w-none print:w-full print:mx-0 print:h-auto print:shadow-none print:rounded-none print:border-none print:overflow-visible">
            <div className="px-6 py-4 border-b border-[#E2E8F0] flex justify-between items-center bg-[#F8FAFC] print:hidden">
              <h3 className="font-bold text-lg text-[#1E293B] flex items-center gap-2">
                <Printer className="w-5 h-5 text-[#800020] " />
              ...
              <div className="flex items-center gap-3">
                 ...
                 <button onClick={() => window.print()} className="flex items-center gap-2 px-4 py-2 bg-[#800020] text-[#F3E6D5] rounded-xl font-bold hover:bg-[#660019] transition-colors cursor-pointer border-none shadow-sm test-sm">
            ...
            <div id="purchase-invoice-printable-area" className="p-8 overflow-y-auto space-y-8 print:overflow-visible print:px-4 print:py-8 bg-white relative">
              <div className="mb-8 border-b-2 border-[#E2E8F0] pb-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-left">
                    <h2 className="text-4xl font-bold text-[#800020]  mb-2 uppercase">فاتورة مشتريات</h2>
