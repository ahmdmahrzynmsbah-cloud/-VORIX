  ...
  return (
    <>
        ...
        <div className={`fixed inset-0 z-50 overflow-y-auto print:bg-transparent print:backdrop-blur-none print:p-0 bg-[#F1F5F9] print:static print:h-auto print:overflow-visible print:block`}>
          <div className="p-3 sm:p-4 flex flex-wrap sm:flex-nowrap gap-2 sm:gap-4 justify-center items-center border-b border-[#E2E8F0] print:hidden bg-white shadow-sm sticky top-0 z-10">
            <button 
              ...
              className="px-4 sm:px-6 py-2 bg-gradient-to-r from-[#800020] to-[#A31535] hover:from-[#660019] hover:to-[#800020] text-[#F3E6D5] rounded-lg text-sm font-bold flex items-center gap-1.5 cursor-pointer shadow-md shadow-[#800020]/25"
            >
      ...
      <div className="space-y-6 print:hidden">
        {/* Top Toggle Bar */}
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 p-1.5 sm:p-2 bg-white rounded-2xl border border-slate-200 shadow-sm">
          <button 
            type="button"
            onClick={() => { resetForm(); setViewMode('create'); }}
            className={`flex-1 py-2.5 sm:py-3 px-4 sm:px-6 rounded-xl font-bold transition-all flex items-center justify-center gap-2 cursor-pointer text-sm sm:text-base ${
              viewMode === 'create' 
                ? 'bg-[#800020] text-[#F3E6D5] shadow-sm' 
                : 'text-slate-600 hover:text-[#800020] hover:bg-[#F3E6D5]/30 bg-transparent border-none'
            }`}
          >
          ...
          <form onSubmit={handleCreateOrUpdateInvoice} className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-[#E2E8F0] p-4 sm:p-6 flex flex-col h-fit lg:sticky lg:top-20 order-2 lg:order-1">
               <div className="flex items-center gap-2 mb-4 sm:mb-6 text-[#1E293B]">
                  <Receipt className="w-5 h-5 sm:w-6 sm:h-6 text-[#800020]" />
               ...
               <div className="space-y-4">
                  ...
                  <div className="space-y-1.5 mb-2">
                    ...
                    <div className="grid grid-cols-2 gap-2 p-1 bg-slate-100 rounded-xl border border-slate-200">
                      <button
                        ...
                        className={`py-2 px-2 sm:px-3 text-xs font-bold rounded-lg transition-all border-none cursor-pointer text-center truncate ${!isQuote ? 'bg-[#800020] text-[#F3E6D5] shadow-sm' : 'bg-transparent text-slate-600 hover:text-slate-800'}`}
                      >
                        فاتورة مبيعات
                      </button>
                      <button
                        ...
                        className={`py-2 px-2 sm:px-3 text-xs font-bold rounded-lg transition-all border-none cursor-pointer text-center truncate ${isQuote ? 'bg-[#D97706] text-white shadow-sm' : 'bg-transparent text-slate-600 hover:text-slate-800'}`}
                      >
                        عرض سعر
                      </button>
                    </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input type="date" required value={invoiceDate} onChange={e => setInvoiceDate(e.target.value)} className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-[#800020] focus:outline-none bg-white font-mono" dir="ltr" />
                  </div>
                  <div className="space-y-1.5">
                    ...
                    {isQuote ? (
                      <input 
                        ...
                        className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-[#D97706] focus:outline-none bg-white font-bold text-right"
                        required
                      />
                    ) : (
                      <div className="flex flex-col gap-2">
                        <div className="flex items-center gap-2">
                          <div className="flex-1 min-w-0">
                            {isCustomCustomer ? (
                              <input 
                                ...
                                value={customerNameInput}
                                onChange={e => setCustomerNameInput(e.target.value)}
                                className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-[#800020] focus:outline-none bg-white font-bold text-right"
                                required
                              />
                            ) : (
                              <select 
                                ...
                                className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-[#800020] focus:outline-none bg-white truncate"
                              >
                          ...
                          <button
                            ...
                            className="shrink-0 px-3 py-2 bg-slate-100 border border-slate-200 rounded-lg text-xs font-bold text-slate-700 hover:bg-slate-200 whitespace-nowrap cursor-pointer transition-colors"
                          >
                  ...
                  <div className="space-y-1">
                    ...
                    {isQuote || isCustomCustomer ? (
                      <input 
                        ...
                        className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-[#800020] focus:outline-none bg-white font-mono" dir="ltr"
                      />
                    ) : (
                      <input 
                        type="text" placeholder="مثال: 055xxxxxxx" value={customerPhoneInput} readOnly
                        className="w-full border border-[#E2E8F0] rounded-lg px-4 py-2 text-sm bg-slate-50" dir="ltr"
                      />
                    )}
                  </div>
                  ...
                  <div className="pt-4 border-t border-[#E2E8F0]">
                    ...
                    <div className="flex items-center justify-between mb-4 gap-2">
                       ...
                       <div className="flex w-full max-w-[180px]">
                         ...
                         <select 
                           ...
                           className="border border-[#E2E8F0] rounded-l-lg px-2 py-1 text-xs sm:text-sm bg-slate-100 focus:outline-none shrink-0"
                         >
                    ...
                    <div className="flex justify-between items-center mt-6 pt-4 border-t border-[#E2E8F0]">
                      ...
                      <span className="font-bold text-xl sm:text-2xl text-[#800020]">{Number(finalTotal || 0).toLocaleString()} <span className="text-sm sm:text-base text-[#94A3B8]">ج.م</span></span>
                    </div>
                  </div>
                      ...
                      {paymentMethod === 'partial' && (
                        <div className="mt-2">
                          ...
                          <input 
                             ...
                             className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-[#800020] focus:outline-none"
                           />
                        </div>
                      )}
                    </div>
                  ...
                  <div className="pt-4">
                     <button type="submit" className={`w-full py-3.5 sm:py-4 rounded-xl font-bold flex items-center justify-center gap-2 transition-all cursor-pointer border-none shadow-md ${isQuote ? 'bg-[#D97706] hover:bg-[#B45309] text-white' : 'bg-gradient-to-r from-[#800020] to-[#A31535] hover:from-[#660019] hover:to-[#800020] text-[#F3E6D5] shadow-md shadow-[#800020]/25'}`}>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                     ...
                     <div className="relative flex-1">
                       ...
                       <input
                         ...
                         className="block w-full border border-[#E2E8F0] rounded-xl pr-10 sm:pr-12 pl-4 py-2.5 sm:py-3 text-xs sm:text-sm focus:ring-2 focus:ring-[#800020] focus:outline-none placeholder:text-xs sm:placeholder:text-sm"
                         ...
                         <div className="absolute top-full right-0 left-0 mt-2 bg-white rounded-xl shadow-xl border border-[#E2E8F0] z-20 max-h-60 overflow-y-auto">
                           {searchResults.map(item => (
                             ...
                             >
                               ...
                               {showDetailsAndPrices && <span className="font-bold text-[#800020]">{Number(item.sellPrice || 0).toLocaleString()} ج.م</span>}
                             </button>
                           ))}
                         </div>
                       )}
                                ...
                                {showDetailsAndPrices && (
                                  <td className="py-3 px-4">
                                    <input 
                                      ...
                                      className="w-24 border border-[#E2E8F0] rounded-lg px-2 py-1 text-center font-bold focus:ring-2 focus:ring-[#800020] focus:outline-none"
                                    />
                                  </td>
                                )}
                                <td className="py-3 px-4">
                                  <input 
                                    ...
                                    className="w-20 border border-[#E2E8F0] rounded-lg px-2 py-1 text-center font-bold focus:ring-2 focus:ring-[#800020] focus:outline-none"
                                  />
                                </td>
                                {showDetailsAndPrices && <td className="py-3 px-4 font-bold text-[#800020]">{Number(qtyTotal || 0).toLocaleString()}</td>}
        ...
        {viewMode === 'list' && (
          <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm flex flex-col overflow-hidden">
            <div className="p-4 sm:p-5 border-b border-slate-100 flex flex-col sm:flex-row gap-4 justify-between items-center bg-white">
              <div className="relative w-full sm:max-w-md">
                ...
                <input
                  ...
                  className="block w-full bg-slate-50 border border-slate-200 rounded-xl pr-10 pl-4 py-2.5 text-sm focus:bg-white focus:border-[#800020] focus:ring-2 focus:ring-[#800020]/20 focus:outline-none transition-all placeholder:text-slate-400 font-medium"
                    ...
                    >
                      <div className="flex justify-between items-start gap-2">
                        <div>
                          <div className="flex items-center gap-1.5 flex-wrap">
                            <span className="font-mono font-black text-sm text-[#800020] bg-[#F3E6D5]/60 border border-[#800020]/20 px-2 py-0.5 rounded-md">
                              #{inv.invoiceNumber}
                            </span>
                            {inv.isQuote ? (
                      ...
                      <div className="flex items-center justify-between pt-1 border-t border-[#E2E8F0]/70">
                        <button 
                          ...
                          className="px-3 py-1.5 bg-[#800020] hover:bg-[#660019] text-[#F3E6D5] rounded-lg text-xs font-bold flex items-center gap-1.5 cursor-pointer shadow-xs"
                        >
                    ...
                    filteredInvoices.map((inv, idx) => {
                      ...
                      return (
                        <tr key={inv.id ? `invoice-${inv.id}` : `invoice-idx-${idx}`} className="hover:bg-[#F8FAFC]">
                          <td className="px-6 py-4 font-mono font-bold text-[#800020]">{inv.invoiceNumber}</td>
                          ...
                          <td className="px-6 py-4 flex items-center justify-center gap-2">
                            <button 
                              ...
                              className="p-1.5 text-[#475569] bg-white border border-[#E2E8F0] rounded-md hover:text-[#800020] hover:border-[#800020] transition-colors cursor-pointer"
